...
shop_options = [
    ...
    #(1,    200, 'number of passing vs. failing private tests on your Assignment 1 submission'),
    #(2,   1250, 'information on the first failing private test for your Assignment 1 submission'),
